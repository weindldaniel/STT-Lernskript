...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{/Users/danielweindl/_source/LaTex/STT-Lernskript/Bilder/BinäreSignalverarbeitung.png}
\end{figure}

\subsubsection{Nach Art der Signalverarbeitung}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{/Users/danielweindl/_source/LaTex/STT-Lernskript/Bilder/ArtenSignalverarbeitung.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{/Users/danielweindl/_source/LaTex/STT-Lernskript/Bilder/SynchronAsynchron.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{/Users/danielweindl/_source/LaTex/STT-Lernskript/Bilder/UnterscheidungEnergieübertragung.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{/Users/danielweindl/_source/LaTex/STT-Lernskript/Bilder/Automatisierungspyramide.png}
\end{figure}
...
\begin{itemize}
    ...
    \item \textbf{Eingabebaugruppen}  
    Erfassen binäre oder analoge Signale aus der Feldebene
    (Sensoren).

    \item \textbf{Ausgabebaugruppen}  
...
\paragraph{Digitale Eingabebaugruppen}
\begin{itemize}
...
\paragraph{Digitale Ausgabebaugruppen}
\begin{itemize}
    \item Schalten binäre Lasten
    \item Typisch: Relais-, Transistor- oder Triac-Ausgänge
\end{itemize}

\paragraph{Analoge Eingabebaugruppen}
\begin{itemize}
    \item Erfassen kontinuierliche Messwerte
    \item Typische Signale: 0–10\,V, 4–20\,mA
\end{itemize}

\paragraph{Analoge Ausgabebaugruppen}
\begin{itemize}
    \item Geben kontinuierliche Stellgrößen aus
    \item Ansteuerung von Frequenzumrichtern, Ventilen, Reglern
\end{itemize}

\subsubsection{Aufbauarten von SPS-Systemen}

\paragraph{Kompakt-SPS}
\begin{itemize}
    \item CPU, E/A und Netzteil in einem Gehäuse
    \item Begrenzte Erweiterbarkeit
    \item Kostengünstig
\end{itemize}

\paragraph{Modulare SPS}
\begin{itemize}
    \item CPU und Baugruppen steckbar
    \item Hohe Flexibilität und Erweiterbarkeit
    \item Industriestandard für mittlere und große Anlagen
\end{itemize}

\paragraph{Dezentrale SPS / verteilte I/O}
\begin{itemize}
    \item E/A-Module nahe am Prozess
    \item Kommunikation über Feldbus
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{/Users/danielweindl/_source/LaTex/STT-Lernskript/Bilder/Zuordnungstabelle.png}
\end{figure}
